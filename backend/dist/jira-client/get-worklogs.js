...
exports.getWorklogs = ({ from, to, jiraClient, userName }) => __awaiter(void 0, void 0, void 0, function* () {
    const searchTo = moment_1.default(to)
        .add(1, "day")
        .toDate();
    const issuesResponse = yield search_issues_1.searchIssues(jiraClient, from, searchTo, userName);
    return yield get_issue_worklogs_1.getIssueWorklogs(issuesResponse.issues, jiraClient, worklog => filterWorklog(worklog, userName, from, searchTo));
});
