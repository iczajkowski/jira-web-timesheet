...
(function(JiraConnectionError) {
  JiraConnectionError[(JiraConnectionError["WrongAddress"] = 0)] =
    "WrongAddress";
  JiraConnectionError[(JiraConnectionError["Unauthorized"] = 1)] =
    "Unauthorized";
  JiraConnectionError[(JiraConnectionError["Forbidden"] = 2)] = "Forbidden";
  JiraConnectionError[(JiraConnectionError["Unknown"] = 3)] = "Unknown";
})(
  (JiraConnectionError =
    exports.JiraConnectionError || (exports.JiraConnectionError = {}))
);
class JiraError {
  constructor() {
